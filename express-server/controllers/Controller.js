...
class Controller {
  ...
  static getRequestBodyName(request) {
    ...
    const refObjectPath =
      request.openapi.schema.requestBody &&
  ...
  static collectRequestParams(request) {
    ...
    const skipBody = method === 'GET' || method === 'DELETE';

    // Body (apenas para POST/PUT/PATCH)
    if (!skipBody && request.openapi.schema.requestBody !== undefined) {
    ...
    // Parâmetros de path, query e header (se existirem)
